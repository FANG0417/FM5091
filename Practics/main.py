...
#        self.SetRiskManagement(MaximumDrawdownPercentPerSecurity(float(stopRisk)))
        ...
        # Alpha Model
        self.AddAlpha(FundamentalFactorAlphaModel(self.num_fine, value_weight, solvency_weight, safety_weight))
    ...
    def FineSelectionFunction(self, fine):
        ...
        #edit to include negative valued fundaments and exclude NoneType values
        filtered_fine = [x.Symbol for x in fine if x.OperationRatios.CashRatio.ThreeMonths > 0
                                                and x.ValuationRatios.EVToEBITDA > 0
                                                and x.ValuationRatios.PBRatio > 0
                                                and x.ValuationRatios.PERatio > 0
                                                and x.ValuationRatios.PricetoEBITDA > 0
                                                and x.ValuationRatios.PSRatio > 0
                                                and x.OperationRatios.CurrentRatio.ThreeMonths > 0
                                                and x.OperationRatios.QuickRatio.ThreeMonths > 0
                                                and x.OperationRatios.InterestCoverage.ThreeMonths > 0
